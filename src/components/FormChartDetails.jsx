...
export default function FormChartDetails() {
  ...
  const rows = [
    ['Очное', onsite + '%', Math.round((total * onsite) / 100).toLocaleString('ru-RU')],
    ['Заочное', remote + '%', Math.round((total * remote) / 100).toLocaleString('ru-RU')],
  ];
