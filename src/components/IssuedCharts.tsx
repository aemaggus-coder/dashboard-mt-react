...
export default function IssuedCharts() {
  ...
  const d = useScaledData((BASE.tsr as Record<string, typeof BASE.tsr.today>)[period] || BASE.tsr.today, ['issuedNat', 'issuedCert']);
  const status = ((BASE.tsr as Record<string, typeof BASE.tsr.today>)[period] || BASE.tsr.today).status;
